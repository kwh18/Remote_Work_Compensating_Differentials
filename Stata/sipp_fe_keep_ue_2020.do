...
esttab using "$tables\fe_keep_ue_all_2020.tex", replace f ///
 ...
 alignment(D{.}{.}{-1}) ///
 mtitles("Earnings" "Wage" "Hours" "Emp" "Earnings" "Wage" "Hours" "Earnings" "Wage" "Hours" "Emp") ///
...
* Employment
* Fixed Effects
eststo: reghdfe emp_status remote_any job_change_year remote_any_job_change_year age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
...
eststo: reghdfe emp_status remote_any job_change_year remote_any_job_change_year age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
 ...
 esttab using "$tables\fe_keep_ue_all_2020.tex", append f ///
 b(%9.3gc) se(3) star(* 0.10 ** 0.05 *** 0.01)  /// 
...
esttab using "$tables\fe_keep_ue_job_change_2020.tex", replace f ///
 prehead(\begin{tabular}{l*{@M}{r}} \toprule) ///
 b(%9.3gc) se(3) star(* 0.10 ** 0.05 *** 0.01)  /// 
...
* Earnings
* Fixed Effects
eststo: reghdfe ln_monthly_earnings remote_any remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)

* Wages
* Fixed Effects
eststo: reghdfe ln_wage remote_any remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
 
* Hours
* Fixed Effects
eststo: reghdfe ln_weekly_hours remote_any remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
 
* Employment
* Fixed Effects
eststo: reghdfe emp_status remote_any remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
...
esttab using "$tables\fe_keep_ue_year_inter_2020.tex", replace f ///
 prehead(\begin{tabular}{l*{@M}{r}} \toprule) ///
 b(%9.3gc) se(3) star(* 0.10 ** 0.05 *** 0.01)  /// 
 keep(remote_any remote_any_2021 remote_any_2022) varlabels(remote_any "Remote Work" remote_any_2021 "Remote Work X 2021" remote_any_2022 "Remote Work X 2022", elist(remote_any_2022 \bottomrule)) ///
 label booktabs nonotes nonumbers noobs collabels(none) ///
 alignment(D{.}{.}{-1}) ///
 mtitles("Earnings" "Wage" "Hours" "Emp" "Earnings" "Wage" "Hours" "Earnings" "Wage" "Hours" "Emp") ///
 mgroups("Any" "Hybrid" "Primarily", pattern(1 0 0 0 1 0 0 0 1 0 0 0) ///
...
* Earnings
* Fixed Effects
eststo: reghdfe ln_monthly_earnings remote_any job_change_year remote_any_job_change_year remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)

* Wages
* Fixed Effects
eststo: reghdfe ln_wage remote_any job_change_year remote_any_job_change_year remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
 
* Hours
* Fixed Effects
eststo: reghdfe ln_weekly_hours remote_any job_change_year remote_any_job_change_year remote_any_2021 remote_any_2022 age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered DN_class cov_rate death_rate [aweight=person_weight], absorb(person_id date) vce(robust)
...
esttab using "$tables\fe_keep_ue_job_change_year_inter_2020.tex", replace f ///
 prehead(\begin{tabular}{l*{@M}{r}} \toprule) ///
 b(%9.3gc) se(3) star(* 0.10 ** 0.05 *** 0.01)  /// 
 keep(remote_any job_change_year remote_any_job_change_year remote_any_2021 remote_any_2022) varlabels(remote_any "Remote Work" job_change_year "Job Change" remote_any_job_change_year "Remote Work X Job Change" remote_any_2021 "Remote Work X 2021" remote_any_2022 "Remote Work X 2022", elist(remote_any_2022 \bottomrule)) ///
 label booktabs nonotes nonumbers noobs collabels(none) ///
 alignment(D{.}{.}{-1}) ///
 mtitles("Earnings" "Wage" "Hours" "Emp" "Earnings" "Wage" "Hours" "Earnings" "Wage" "Hours" "Emp") ///
 mgroups("Any" "Hybrid" "Primarily", pattern(1 0 0 0 1 0 0 0 1 0 0 0) ///
