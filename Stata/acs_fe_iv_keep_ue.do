...
esttab using "$tables\ACS_ann_keep_ue_2018.tex", append f ///
 ...
 addnotes("Sample: 2018-2021. Annual observations of prime-age individuals employed at some point in the last two years. Individual outliers in 1st and outside of 99th percentile of average monthly earnings are dropped from sample. Since ACS does not classify hybrid individuals, nobody is dropped" ///
