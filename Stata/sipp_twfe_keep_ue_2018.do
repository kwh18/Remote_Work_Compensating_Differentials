...
xi: did_multiplegt ln_monthly_earnings person_id date remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_any_earnings_keep_ue_2018")
...
xi: did_multiplegt ln_wage person_id date remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_any_wage_keep_ue_2018")
...
xi: did_multiplegt ln_weekly_hours person_id date remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_any_hours_keep_ue_2018")
...
xi: did_multiplegt emp_status person_id date remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_any_emp_status_keep_ue_2018")
...
xi: did_multiplegt ln_monthly_earnings person_id date remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_some_earnings_keep_ue_2018")
...
xi: did_multiplegt ln_wage person_id date remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_some_wage_keep_ue_2018")
...
xi: did_multiplegt ln_weekly_hours person_id date remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_some_hours_keep_ue_2018")
...
xi: did_multiplegt emp_status person_id date remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_some_emp_status_keep_ue_2018")
...
xi: did_multiplegt ln_monthly_earnings person_id date remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_primary_earnings_keep_ue_2018")
...
xi: did_multiplegt ln_wage person_id date remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_primary_wage_keep_ue_2018")
...
xi: did_multiplegt ln_weekly_hours person_id date remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_primary_hours_keep_ue_2018")
...
xi: did_multiplegt emp_status person_id date remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index DN_class cov_rate death_rate i.jobid_1) weight(person_weight) save_results("twfe_primary_emp_status_keep_ue_2018")

esttab using "$tables\main_keep_ue_twfe_2018.tex", replace f ///
