...
xi: did_multiplegt ln_annual_earnings person_id year remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_any_earnings_switchers_2020")
...
xi: did_multiplegt ln_wage person_id year remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_any_wage_switchers_2020")
...
xi: did_multiplegt ln_weekly_hours person_id year remote_any, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_any_hours_switchers_2020")
...
xi: did_multiplegt ln_annual_earnings person_id year remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_some_earnings_switchers_2020")
...
xi: did_multiplegt ln_wage person_id year remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_some_wage_switchers_2020")
...
xi: did_multiplegt ln_weekly_hours person_id year remote_some, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_some_hours_switchers_2020")
...
xi: did_multiplegt ln_annual_earnings person_id year remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_primary_earnings_switchers_2020")
...
xi: did_multiplegt ln_wage person_id year remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_primary_wage_switchers_2020")
...
xi: did_multiplegt ln_weekly_hours person_id year remote_primary, cluster(clust_iv) breps(100) seed(1234) controls(age age_sq i.household_relationship i.worker_class i.occupation_code_agg i.industry_code_agg i.state_code female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered stringency_index i.jobid_1) weight(person_weight) save_results("twfe_primary_hours_switchers_2020")

esttab using "$tables\main_twfe_switchers_2020.tex", replace f ///
