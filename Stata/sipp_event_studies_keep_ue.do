...
graph export "$tables\event_study_wages_remote_any_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_earnings_remote_any_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_hours_remote_any_keep_ue.png", replace as(png)

* Employment Status
eventdd emp_status age age_sq i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered i.household_relationship i.worker_class i.industry_code_agg i.occupation_code_agg i.date, timevar(dist_from_edate_any) accum leads(8) lags(8) cluster(person_id) graph_op(legend(off) title( "{stSerif:{it:Trends in Employment Status at WFH Switch (Any)}}", color(black) size(large)) xtitle("{stSerif:Months Since WFH Switch}") xscale(titlegap(2)) note("{stSerif:{it:Notes}. Naive Event Study technique used. Controls include age, age^2, state of residence, weekly hours,}" "{stSerif:gender, race, education, household relationship, worker class, industry and occupation. Date and individual}" "{stSerif:fixed effects included. Errors are clustered at the individual level.}", margin(small)) graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white) ilwidth(vvvthin)) mcolor(black))
graph export "$tables\event_study_emp_status_remote_any_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_wages_remote_some_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_earnings_remote_some_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_hours_remote_some_keep_ue.png", replace as(png)

* Employment Status
eventdd emp_status age age_sq i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered i.household_relationship i.worker_class i.industry_code_agg i.occupation_code_agg i.date, timevar(dist_from_edate_some) accum leads(8) lags(8) cluster(person_id) graph_op(legend(off) title( "{stSerif:{it:Trends in Employment Status at WFH Switch (Some)}}", color(black) size(large)) xtitle("{stSerif:Months Since WFH Switch}") xscale(titlegap(2)) note("{stSerif:{it:Notes}. Naive Event Study technique used. Controls include age, age^2, state of residence, weekly hours,}" "{stSerif:gender, race, education, household relationship, worker class, industry and occupation. Date and individual}" "{stSerif:fixed effects included. Errors are clustered at the individual level.}", margin(small)) graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white) ilwidth(vvvthin)) mcolor(black))
graph export "$tables\event_study_emp_status_remote_some_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_wages_remote_primary_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_earnings_remote_primary_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_hours_remote_primary_keep_ue.png", replace as(png)

* Employment Status
eventdd emp_status age age_sq i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered i.household_relationship i.worker_class i.industry_code_agg i.occupation_code_agg i.date, timevar(dist_from_edate_primary) accum leads(8) lags(8) cluster(person_id) graph_op(legend(off) title( "{stSerif:{it:Trends in Employment Status at WFH Switch (Primary)}}", color(black) size(large)) xtitle("{stSerif:Months Since WFH Switch}") xscale(titlegap(2)) note("{stSerif:{it:Notes}. Naive Event Study technique used. Controls include age, age^2, state of residence, weekly hours,}" "{stSerif:gender, race, education, household relationship, worker class, industry and occupation. Date and individual}" "{stSerif:fixed effects included. Errors are clustered at the individual level.}", margin(small)) graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white) ilwidth(vvvthin)) mcolor(black))
graph export "$tables\event_study_emp_status_remote_primary_keep_ue.png", replace as(png)
...
graph export "$tables\event_study_wages_remote_any_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_earnings_remote_any_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_hours_remote_any_keep_ue_SA.png", replace as(png)

* Employment Status
eventstudyinteract emp_status g_8_any g_7_any g_6_any g_5_any g_4_any g_3_any g_2_any g0_any g1_any g2_any g3_any g4_any g5_any g6_any g7_any g8_any g_1_any, cohort(edate_any) control_cohort(control_any) covariates(age age_sq i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered i.household_relationship i.worker_class i.industry_code_agg i.occupation_code_agg) absorb(i.date i.person_id) vce(cluster person_id)
...
coefplot matrix(B[1]), vertical se(B[2]) ciopts(recast(rcap)) legend(off) title( "{stSerif:{it:Trends in Employment at WFH Switch (Any)}}", color(black) size(large)) xtitle("{stSerif:Months Since WFH Switch}") note("{stSerif:{it:Notes}. Sun and Abraham (2020) technique used. Controls include age, age^2, state of residence, weekly hours,}" "{stSerif:gender, race, education, household relationship, worker class, industry and occupation. Date and individual}" "{stSerif:fixed effects included. Errors are clustered at the individual level.}", margin(small)) xscale(titlegap(2)) graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white) ilwidth(vvvthin)) mcolor(black) xline(8, lcolor(black) lwidth(thin)) yline(0)
graph export "$tables\event_study_emp_status_remote_any_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_wages_remote_some_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_earnings_remote_some_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_hours_remote_some_keep_ue_SA.png", replace as(png)

* Employment Status
eventstudyinteract emp_status g_8_some g_7_some g_6_some g_5_some g_4_some g_3_some g_2_some g0_some g1_some g2_some g3_some g4_some g5_some g6_some g7_some g8_some g_1_some, cohort(edate_some) control_cohort(control_some) covariates(age age_sq i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered i.household_relationship i.worker_class i.industry_code_agg i.occupation_code_agg) absorb(i.date i.person_id) vce(cluster person_id)
...
coefplot matrix(B[1]), vertical se(B[2]) ciopts(recast(rcap)) legend(off) title( "{stSerif:{it:Trends in Employment at WFH Switch (Some)}}", color(black) size(large)) xtitle("{stSerif:Months Since WFH Switch}") note("{stSerif:{it:Notes}. Sun and Abraham (2020) technique used. Controls include age, age^2, state of residence, weekly hours,}" "{stSerif:gender, race, education, household relationship, worker class, industry and occupation. Date and individual}" "{stSerif:fixed effects included. Errors are clustered at the individual level.}", margin(small)) xscale(titlegap(2)) graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white) ilwidth(vvvthin)) mcolor(black) xline(8, lcolor(black) lwidth(thin)) yline(0)
graph export "$tables\event_study_emp_status_remote_some_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_wages_remote_primary_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_earnings_remote_primary_keep_ue_SA.png", replace as(png)
...
graph export "$tables\event_study_hours_remote_primary_keep_ue_SA.png", replace as(png)

* Employment Status
eventstudyinteract emp_status g_8_primary g_7_primary g_6_primary g_5_primary g_4_primary g_3_primary g_2_primary g0_primary g1_primary g2_primary g3_primary g4_primary g5_primary g6_primary g7_primary g8_primary g_1_primary, cohort(edate_primary) control_cohort(control_primary) covariates(age age_sq i.state_code weekly_hours female hispanic black asian resid_race hsgraduate somecollege associates bachelors highered i.household_relationship i.worker_class i.industry_code_agg i.occupation_code_agg) absorb(i.date i.person_id) vce(cluster person_id)
...
coefplot matrix(B[1]), vertical se(B[2]) ciopts(recast(rcap)) legend(off) title( "{stSerif:{it:Trends in Employment at WFH Switch (Primary)}}", color(black) size(large)) xtitle("{stSerif:Months Since WFH Switch}") note("{stSerif:{it:Notes}. Sun and Abraham (2020) technique used. Controls include age, age^2, state of residence, weekly hours,}" "{stSerif:gender, race, education, household relationship, worker class, industry and occupation. Date and individual}" "{stSerif:fixed effects included. Errors are clustered at the individual level.}", margin(small)) xscale(titlegap(2)) graphregion(fcolor(white) lcolor(white) lwidth(vvvthin) ifcolor(white) ilcolor(white) ilwidth(vvvthin)) mcolor(black) xline(8, lcolor(black) lwidth(thin)) yline(0)
graph export "$tables\event_study_emp_status_remote_primary_keep_ue_SA.png", replace as(png)
